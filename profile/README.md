...
- Families managing money across distance
- Roommates splitting rent and bills
- Friends saving toward a shared goal
- Communities running savings circles (ajo/esusu)
- Parents supporting students away from home

---

## Get Involved

TriSig is built in public. We welcome developers, designers, and anyone who cares about financial infrastructure for underserved communities.

- Browse our repos and open issues
- Read the [contributing guide](https://github.com/your-org/trisig/blob/main/CONTRIBUTING.md)
